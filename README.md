...
A Node.js web application for **SWG (Star Wars Galaxies)** servers. It provides resource tracking, schematic browsing, item lookup, quest journal, terrain mapping, and player/city administration.
